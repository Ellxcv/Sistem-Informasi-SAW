        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="nilai_kualitas" class="form-control" placeholder="Nilai Kualitas">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Nilai Pelayanan:</strong>
                    <input type="text" name="nilai_pelayanan" class="form-control" placeholder="Nilai Pelayanan">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Nilai Lokasi:</strong>
                    <input type="text" name="nilai_lokasi" class="form-control" placeholder="Nilai Lokasi">
                </div>
            </div>
